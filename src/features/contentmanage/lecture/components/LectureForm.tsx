      ...
      <fieldset className="mt-6 space-y-6" disabled={isSubmitting}>
        ...
        <div>
          ...
          <div className="mt-1 flex items-center justify-between">
            {errors.title ? (
              <p id="lecture-title-error" className="text-[13px] text-[#DC2626]">
                {errors.title}
              </p>
            ) : (
              <span />
        ...
        <div>
          ...
          <div className="mt-1 flex items-center justify-between">
            {errors.description ? (
              <p id="lecture-description-error" className="text-[13px] text-[#DC2626]">
                {errors.description}
              </p>
            ) : (
              <span />
        ...
        <div>
          ...
          >
            ...
            <span className="mt-2 text-[13px] font-medium text-[#344054]">
              문서 파일 업로드 (PDF, Word, PPT, Excel, HWP, TXT)
            </span>
            <input

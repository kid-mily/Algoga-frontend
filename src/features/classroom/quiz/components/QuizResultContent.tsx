    ...
    <>
      <div className="flex w-full justify-center">
        <div className="flex w-full max-w-[560px] flex-col items-center text-center">
          <div className="w-full rounded-2xl border border-[#BDE4CA] bg-[#EFFAF2] px-5 py-4 text-left">
            ...
            <div className="mt-3 flex gap-2">
              <Link
                ...
                className="flex h-9 flex-1 items-center justify-center rounded-xl bg-[#439A97] text-xs font-bold text-white"
              >
                수료증 확인
              </Link>
              ...
              <Link
                ...
                className="flex h-9 flex-1 items-center justify-center rounded-xl border border-[#8AB9B7] bg-white text-xs font-bold text-[#439A97]"
              >
                혜택 확인
              </Link>
            </div>
          ...
          <div className="mt-5 flex h-12 w-12 items-center justify-center rounded-full bg-[#EEF8F7] text-lg font-bold text-[#439A97]">
            ✓
          </div>

          <h2 className="mt-3 text-xl font-bold text-[#0A1628]">
            퀴즈 완료
          </h2>
          ...
          <div className="mt-5 w-full rounded-2xl bg-[#F8FAFC] px-5 py-4">
            <div className="grid grid-cols-[1fr_auto_1fr] items-center">
              ...
              <div className="h-10 w-px bg-[#E1E7EF]" />
          ...
          <button
            ...
            className="mt-4 h-11 w-full rounded-xl border border-[#8AB9B7] bg-white text-sm font-bold text-[#439A97] disabled:cursor-not-allowed disabled:opacity-50"
          >
          ...
          {reviewWritten ? (
            <Link
              href={reviewHref}
              className="mt-2 flex h-11 w-full items-center justify-center rounded-xl bg-[#439A97] text-sm font-bold text-white"
            >
              수강 후기 보기
            </Link>
          ) : (
            <button
              type="button"
              onClick={onReview}
              className="mt-2 h-11 w-full rounded-xl bg-[#439A97] text-sm font-bold text-white"
            >
              수강 후기 작성하기
            </button>
          )}
          ...
          <button
            type="button"
            onClick={onClose}
            className="mt-2 h-11 w-full rounded-xl border border-[#DCE5F0] bg-white text-sm font-bold text-[#243247]"
          >
            강의로 돌아가기
          </button>
        </div>

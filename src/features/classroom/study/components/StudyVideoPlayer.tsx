...
export default function StudyVideoPlayer({
  ...
  return (
    <article className="mx-auto w-full max-w-[820px] overflow-hidden rounded-lg border border-[#D6E3E7] bg-[#101820] shadow-sm">
      <div className="relative aspect-video w-full bg-black">
        {selectedChapter?.videoUrl ? (
          <>
            ...
            <div className="pointer-events-none absolute left-4 top-4 rounded-full bg-[#315E62]/85 px-3 py-1.5 text-xs font-bold text-white backdrop-blur-sm">
            ...
            {!isPlaying && (
              <button
                ...
                className="absolute left-1/2 top-1/2 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white/60 bg-[#6D9F9B]/90 text-white shadow-lg transition hover:scale-105 hover:bg-[#5A8F8A]"
              >

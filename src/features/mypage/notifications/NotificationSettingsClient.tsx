...
const notificationItems = [
    ...
    },
    {
        id: "qna",
        title: "Q&A 알림",
        description: "작성한 강의 Q&A에 답변이 등록되면 알림을 받을 수 있어요.",
    },
    {
        id: "community",
        title: "커뮤니티 댓글 알림",
    ...
    return (
        <section className="rounded-2xl bg-white px-8 py-5 shadow-sm">
        <div className="rounded-2xl border border-[#F3C74D] bg-[#FFFBEA] px-4 py-3 text-sm font-medium text-[#9A6B00]">
